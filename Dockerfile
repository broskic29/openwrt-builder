...
ENV PROFILE="rpi-4"
ENV PACKAGES="luci vim htop curl wget bash lighttpd luci-app-nlbwmon nlbwmon luci-app-qos sqm-scripts collectd collectd-mod-network logrotate tcpdump git openssh-server openssh-sftp-server"
ENV FILES="files"
